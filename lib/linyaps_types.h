...
typedef void (*LinyapsInteractionCallback)(
    const LinyapsInteractionRequest *request, void *userdata);
...
typedef void (*LinyapsCompletionCallback)(int error_code, const char *message,
                                          void *userdata);
