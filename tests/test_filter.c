...
static LinyapsPackageInfo *make_pkg(const char *repo,
                                     const char *id,
                                     const char *module,
                                     const char *version)
{
...
{
    size_t count = 0;
    LinyapsPackageInfo **list = pack_list(&count,
        make_pkg("stable", "org.app", "binary",  "1.0.0"),
        make_pkg("stable", "org.app", "develop", "1.0.0"),
        NULL);
...
static void test_filter_different_ids_kept(void)
{
    size_t count = 0;
    LinyapsPackageInfo **list = pack_list(&count,
        make_pkg("stable", "org.app1", "binary", "1.0.0"),
        make_pkg("stable", "org.app2", "binary", "1.0.0"),
        NULL);
...
static void test_filter_different_modules_kept(void)
{
    ...
    LinyapsPackageInfo **list = pack_list(&count,
        make_pkg("stable", "org.app", "binary",  "1.0.0"),
        make_pkg("stable", "org.app", "runtime", "1.0.0"),
        NULL);
...
static void test_filter_mixed_scenario(void)
{
    ...
    filter_store_search_results(&list, &count);
    /* Expected: org.app/binary/stable(2.0.0), org.app/binary/testing(1.0.0), org.other/binary/stable(1.0.0) */
    assert(count == 3);
    linyaps_package_info_list_free(list, count);
...
static void test_filter_null_repo_treated_as_empty(void)
{
    ...
    size_t count = 0;
    LinyapsPackageInfo **list = pack_list(&count,
        make_pkg(NULL, "org.app", "binary", "1.0.0"),
        make_pkg(NULL, "org.app", "binary", "2.0.0"),
        NULL);
...
static void test_filter_null_module_treated_as_empty(void)
{
    ...
    size_t count = 0;
    LinyapsPackageInfo **list = pack_list(&count,
        make_pkg("stable", "org.app", NULL, "1.0.0"),
        make_pkg("stable", "org.app", NULL, "3.0.0"),
        NULL);
...
static void test_filter_keeps_single_entry(void)
{
    size_t count = 0;
    LinyapsPackageInfo **list = pack_list(&count,
        make_pkg("stable", "org.lonely", "binary", "0.1.0"),
        NULL);
