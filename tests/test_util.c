...
static void test_state_string_all_values(void) {
  ASSERT_STR_EQ(linyaps_task_state_string(LINYAPS_TASK_STATE_UNKNOWN),
                "Unknown");
  ASSERT_STR_EQ(linyaps_task_state_string(LINYAPS_TASK_STATE_QUEUED), "Queued");
  ASSERT_STR_EQ(linyaps_task_state_string(LINYAPS_TASK_STATE_PENDING),
                "Pending");
  ASSERT_STR_EQ(linyaps_task_state_string(LINYAPS_TASK_STATE_PROCESSING),
                "Processing");
  ASSERT_STR_EQ(linyaps_task_state_string(LINYAPS_TASK_STATE_SUCCEED),
                "Succeed");
  ASSERT_STR_EQ(linyaps_task_state_string(LINYAPS_TASK_STATE_FAILED), "Failed");
  ASSERT_STR_EQ(linyaps_task_state_string(LINYAPS_TASK_STATE_CANCELED),
                "Canceled");
...
static void test_to_package_info_full(void) {
  ...
  /* icon_url, zh_name, category_* should NOT be copied (not in
   * LinyapsPackageInfo) */
