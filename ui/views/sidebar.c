...
static void sidebar_nav_item(int uid, NavItem item, const char *label,
  ...
  CLAY(eid,
    ...
    if (item == NAV_UPDATES && g_state->update_count > 0) {
      CLAY(
          CLAY_SIDI(CLAY_STRING("NavSpacer"), uid + 100),
...
void view_sidebar(void) {
  CLAY(
      CLAY_SIDI(CLAY_STRING("Sidebar"), ID_SIDEBAR),
      {
          .layout =
              {
    ...
    sidebar_nav_item(0, NAV_RECOMMENDED, NAV_LABELS[NAV_RECOMMENDED],
                     "\xe2\x99\xa1");
    sidebar_nav_item(1, NAV_ALL, NAV_LABELS[NAV_ALL], "\xe2\x98\xb0");
    sidebar_nav_item(2, NAV_RANKING, NAV_LABELS[NAV_RANKING],
                     "\xf0\x9f\x93\x8a");
    ...
    sidebar_nav_item(4, NAV_CAT_OFFICE, NAV_LABELS[NAV_CAT_OFFICE],
                     "\xf0\x9f\x96\xa5");
    sidebar_nav_item(5, NAV_CAT_SYSTEM, NAV_LABELS[NAV_CAT_SYSTEM],
                     "\xe2\x9a\x99");
    sidebar_nav_item(6, NAV_CAT_DEV, NAV_LABELS[NAV_CAT_DEV], "\xe2\x8c\xa8");
    sidebar_nav_item(7, NAV_CAT_GAMES, NAV_LABELS[NAV_CAT_GAMES],
                     "\xf0\x9f\x8e\xae");
    ...
    UI_ROW(ID_SIDEBAR + 22, DS_SPACE_1) {
      UI_IconButton(ID_SIDEBAR + 23, "\xf0\x9f\x93\x81", DS_FS_LG, UI_BTN_GHOST,
                    false);
      UI_IconButton(ID_SIDEBAR + 24, "\xe2\xac\x87", DS_FS_LG, UI_BTN_GHOST,
                    false);
      UI_IconButton(ID_SIDEBAR + 26, "\xe2\x9a\x99", DS_FS_LG, UI_BTN_GHOST,
                    false);
    }
  }
}
  ...
  CLAY(CLAY_SIDI(CLAY_STRING("CatBar"), ID_CAT_BAR),
    ...
    for (int i = 0; i < CAT_COUNT; i++) {
      ...
      CLAY(eid, {
                    .layout =
                        {
                            .sizing = {CLAY_SIZING_FIT(DS_SPACE_4),
